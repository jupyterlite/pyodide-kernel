...
export * as pipliteWheelUrl from '../pypi/piplite-0.9.0a0-py3-none-any.whl';
export * as pyodide_kernelWheelUrl from '../pypi/pyodide_kernel-0.9.0a0-py3-none-any.whl';
